-- walmart_db.walmart Project Queries - MySQL

SELECT * FROM walmart_db.walmart;

select count(*) from walmart_db.walmart; -- Count total_amount records

-- drop table walmart_db.walmart;

-- delete from walmart_db.walmart;

set sql_safe_updates=1; -- Prevents accidental deletions/updates without a WHERE condition
